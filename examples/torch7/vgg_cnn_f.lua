...
-- prepare data
mean    = torch.load('../../data/ilsvrc/ilsvrc_2012_mean.t7').img_mean:transpose
(3,1)
mean    = image.scale(mean, 224, 224, 'bilinear')

-- construct CNN
model = loadcaffe.load('../../data/vgg_cnn_f/VGG_CNN_F_deploy.prototxt', '../../data/vgg_cnn_f/VGG_CNN_F.caffemodel', 'nn')
...
-- exec prediction
-- t = benchmark_median("./bench_vgg_cnn_f_lua.txt", 10, function()
